		...
		if (dialogId == 10000) {
			...
			switch (getNpcId()) {
				case 799517:
					...
					TeleportService.teleportTo(player, 300170000, 958.45233f, 430.4892f, 219.80301f, 3000, true);
					break;
				case 799518:
					PacketSendUtility.sendPacket(player, new SM_PLAY_MOVIE(0, 0, 449, true));
					TeleportService.teleportTo(player, 300170000, 822.0199f, 465.1819f, 220.29918f, 3000, true);
					break;
				case 799519:
					PacketSendUtility.sendPacket(player, new SM_PLAY_MOVIE(0, 0, 450, true));
					TeleportService.teleportTo(player, 300170000, 777.1054f, 300.39005f, 219.89926f, 3000, true);
					break;
				case 799520:
					PacketSendUtility.sendPacket(player, new SM_PLAY_MOVIE(0, 0, 451, true));
					TeleportService.teleportTo(player, 300170000, 942.3092f, 270.91855f, 219.86185f, 3000, true);
					break;
			}
		}
		return true;
